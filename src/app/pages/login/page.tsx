        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className="relativ">
              <div
                className={`w-16 h-16 bg-gradient-to-b from-gray-200 via-gray-400 to-gray-300 rounded-full flex absolute items-center justify-center border-spacing-3 cursor-pointer  transition-all duration-500 ease-custom-ease group shadow-[0px_10px_20px_rgba(0,0,0,0.3),_0px_4px_6px_rgba(0,0,0,0.2)] hover:shadow-[0px_8px_20px_rgba(0,0,0,1)] hover:scale-105 hover:w-[200px]  hover:px-6${
